...
# Carga las imágenes
fondo_image = pygame.image.load('fondofinal.png').convert()
enemy_image_full = pygame.image.load('enemigo.png').convert()
wall_image = pygame.image.load('wall.png').convert()
player_images = [pygame.image.load('pp1.png').convert_alpha(),
                 pygame.image.load('pp2.png').convert_alpha(),
                 pygame.image.load('pp3.png').convert_alpha()]  # Replace with your actual frames
bonfire_images = [pygame.image.load('bf1.png').convert_alpha(),
                 pygame.image.load('bf2.png').convert_alpha(),
                 pygame.image.load('bf3.png').convert_alpha()]  # Replace with your actual frames
door_image = pygame.image.load('door.png').convert()
item_image = pygame.image.load('cofre.png').convert()
enemy_images = [pygame.image.load('e1.png').convert_alpha(),
                 pygame.image.load('e2.png').convert_alpha(),
                 pygame.image.load('e3.png').convert_alpha()]  # Replace with your actual frames
lava_images = [pygame.image.load('l1.png').convert_alpha(),
                 pygame.image.load('l2.png').convert_alpha(),
                 pygame.image.load('l3.png').convert_alpha()]  # Replace with your actual frames
floor_image = pygame.image.load('empty.png').convert()
cbg = pygame.image.load('bg_combat.png').convert()
bonfire_image_full = pygame.image.load('bonfire.png').convert()
